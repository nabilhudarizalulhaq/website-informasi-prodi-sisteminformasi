        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <div class="section_title text-center mb-70">
                    <h3 class="mb-45">Kumpulan Berita Jurusan</h3>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <?php foreach ($data->result() as $row) : ?>
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?php echo base_url() . 'assets/images/12.jpg' . $row->tulisan_gambar; ?>" alt="<?php echo $row->tulisan_judul; ?>">
                    ...
                    <aside class="single_sidebar_widget popular_post_widget">
                        ...
                        <?php foreach ($populer->result() as $row) : ?>
                            <div class="media post_item">
                                <img width="35%" class="img-fluid" src="<?php echo base_url() . 'assets/images/12.jpg' . $row->tulisan_gambar; ?>" alt="post">

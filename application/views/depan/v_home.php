...
<div class="video">
    <video playsinline muded loop width="100%" height="" nodownload controls autoplay>
        <source src="style/img/web.mp4" controlslis="nodownload" type="video/mp4">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <div class="section_title text-center mb-70">
                    <h3 class="mb-45">Berita Jurusan</h3>
        ...
        <div class="row">
            ...
            <?php foreach ($berita->result() as $row) : ?>
                <div class="col-md-6">
                    <div class="single__news" style="color: darkgreen;">
                        <div class="thumb">
                            ...
                            <span class="badge" style="background-color: darkgreen;"><?php echo $row->tulisan_kategori_nama; ?></span>
                        </div>
                        <div class="news_info ">
                            <a href="<?php echo site_url('artikel/' . $row->tulisan_slug); ?>">
                                <h4 style="color: darkgreen;"><?php echo $row->tulisan_judul; ?></h4>
                            </a>
                            <p><?php echo limit_words($row->tulisan_isi, 40) . '...'; ?></p>
...
<div class="recent_event_area section__padding">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <div class="section_title text-center mb-70">
                    <h3 class="mb-45">Agenda Jurusan</h3>

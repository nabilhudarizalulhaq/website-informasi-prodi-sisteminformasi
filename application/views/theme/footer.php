            ...
            <div class="row">
                <div class="col-xl-3 col-md-4 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <img width="150" src="<?php echo base_url(''); ?>style/img/logo SI.png" class="rounded" alt="IS_20">
                    </div>
                </div>
                <div class="col-xl-3 col-md-4 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo site_url('about'); ?>">Sekilas</a></li>
                            <li><a href="<?php echo site_url('artikel'); ?>">Berita Jurusan</a></li>
                            <li><a href="<?php echo site_url('galeri'); ?>">Galeri Jurusan</a></li>
                            <li><a href="<?php echo site_url('contact'); ?>">Alamat Jurusan</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-xl-3 col-md-6 col-lg-3">
                    <div class="footer_widget">
                        ...
                        <ul>
                            <li><a href="<?php echo site_url('guru'); ?>">Daftar Dosen</a></li>
                    ...
                    <div class="footer_widget">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>Information System-IS_2020</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>sisteminformasi@unibamadura.ac.id</p>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    ...
                    <p>
                        ...
                        </script> <a href="#" target="_blank">Information System-IS_2020</a>
                    </p>
                    </p>
                </div>
            </div>
